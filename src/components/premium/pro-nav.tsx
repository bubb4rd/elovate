...
/**
 * `/pro` tab bar (PREM suite). Same interaction + animated underline as
 * SettingsNav — one route per Pro feature. Add a row here when a new
 * `src/app/pro/<feature>` route lands.
 */
const ITEMS: {
  href: string;
  label: string;
