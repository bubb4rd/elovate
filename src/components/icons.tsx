...
export function ClimbSessionIcon({ className }: { className?: string }) {
  return (
    <svg aria-hidden viewBox="0 0 256 256" className={cn("shrink-0", className)}>
      ...
      <path
        fill="url(#climb-session-gold)"
        d="M10 205 L18 190 L70 126 L91 103 L98 101 L105 104 L126 126 L129 128 L134 128 L219 27 L237 8 L244 8 L247 12 L248 111 L247 239 L245 243 L239 247 L164 248 L13 246 L8 238 L9 206 Z"
      />
    </svg>
  );
}
